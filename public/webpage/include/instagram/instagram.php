...
$initial_token = "IGQVJXc25jTE10SlpEcVN4TGxVWG12U2VqR0dmMDNjOC1maTZAYUG5ualNYaDRyUVI2TElBQnp0ZADQ4Y2YxeXJuVVJKOEJ4eEFSamEweV9TcU9rUVJIUEwzWU01QnNpWGhrdXZAGS0EwNV8xdFJGYXpLWAZDZD
"; // Your Initial Access Token

function cnvs_refresh_token( $token, $token_file ) {
	$instagram_token = curl_init();
	curl_setopt( $instagram_token, CURLOPT_URL, "https://graph.instagram.com/refresh_access_token?grant_type=ig_refresh_token&access_token=IGQVJXc25jTE10SlpEcVN4TGxVWG12U2VqR0dmMDNjOC1maTZAYUG5ualNYaDRyUVI2TElBQnp0ZADQ4Y2YxeXJuVVJKOEJ4eEFSamEweV9TcU9rUVJIUEwzWU01QnNpWGhrdXZAGS0EwNV8xdFJGYXpLWAZDZD" . $token );
...
if ( !$last || (( $now - $last ) > $interval ) ) {
	...
	curl_setopt( $instagram_api, CURLOPT_URL, "https://graph.instagram.com/me/media?fields=id&access_token=IGQVJXc25jTE10SlpEcVN4TGxVWG12U2VqR0dmMDNjOC1maTZAYUG5ualNYaDRyUVI2TElBQnp0ZADQ4Y2YxeXJuVVJKOEJ4eEFSamEweV9TcU9rUVJIUEwzWU01QnNpWGhrdXZAGS0EwNV8xdFJGYXpLWAZDZD" . $final_token );
	...
	if( is_array( $images ) && ! empty( $images ) ) {
		foreach( $images as $image ) {
			...
			curl_setopt( $insta_image, CURLOPT_URL, "https://graph.instagram.com/" . $image['id'] . "?fields=media_url,permalink,media_type,thumbnail_url&access_token=IGQVJXc25jTE10SlpEcVN4TGxVWG12U2VqR0dmMDNjOC1maTZAYUG5ualNYaDRyUVI2TElBQnp0ZADQ4Y2YxeXJuVVJKOEJ4eEFSamEweV9TcU9rUVJIUEwzWU01QnNpWGhrdXZAGS0EwNV8xdFJGYXpLWAZDZD" . $final_token );
